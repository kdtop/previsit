...
import { createCategorySection, createHeading, createCheckboxList,
         createDetailsBox, createQuestionGroup } from './questcommon.js';
...
//
    ...
    /*
    private createCategorySection = (parent: HTMLElement): HTMLDivElement => {
    ...
    private createHeading = (level: number, text: string): HTMLHeadingElement => {
        const h = document.createElement(`h${level}`) as HTMLHeadingElement;
        h.textContent = text;
        return h;
    }

    private createCheckboxList = (prefix: string, items: string[]): HTMLUListElement => {
    ...
    private createDetailsBox = (prefix: string, labelText: string): HTMLDivElement => {
        const div = document.createElement('div');
    ...
    */
    ...
    /*
    private createQuestionGroup = (parent: HTMLElement, prefix: string, text: string): void => {
    ...
    */
     ...
     */
    private dataToServer = (): Record<string, string | boolean> => {
      if (!this.htmlEl) return {};
