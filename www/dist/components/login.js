...
export default class TLoginAppView extends TAppView {
    ...
    async doLogin() {
        ...
        let aLastName = capitalizeWords(formData.get('lastName') || ''); // Ensure lastName is trimmed and capitalized
        let aFirstName = capitalizeWords(formData.get('firstName') || ''); // Ensure firstName is trimmed and capitalized
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                if (this.htmlEl.$welcomename)
                    this.htmlEl.$welcomename.textContent = this.ctrl.patientFullName;
                if (this.htmlEl.$body)
