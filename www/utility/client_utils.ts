...
export function strToNumDef(str: string | undefined, defaultNum: number): number {
    if (str === undefined || str.trim() === "") return defaultNum; // reject empty or whitespace-only strings
    const n = Number(str);
